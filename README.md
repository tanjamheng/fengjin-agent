...
本仓库的开源许可证仅覆盖原创代码与原创文档；第三方角色、图片、剧情文本、语音文本等素材不属于 MIT 授权范围。仓库和 release 包中保留的第三方相关资料仅用于本同人项目的非商业学习交流与角色还原目的。
...
原创代码与原创文档采用 MIT License。第三方角色、图片、剧情文本、语音文本及知识库资料不属于 MIT 授权范围，详见 `THIRD_PARTY_ASSETS.md`；第三方开源软件依赖说明见 `THIRD_PARTY_NOTICES.md`。
